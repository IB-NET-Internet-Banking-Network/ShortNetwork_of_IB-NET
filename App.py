...
payProPortNumber = 9990         #payment processor port number
...
def sendData(fullData, paymentAmount):
    ...
    print('plaintext for confirmation: ',Plaintext)
    ...
    # Decryption of feedback message
    ...
    if mes=="True":
        ...
        print('plaintext for payment information: ',Plaintext)
...
def DebitCardPayment(usr):
    ...
    if request.method == "POST":
        ...
        if(str(UsercardNumber)==""or str(ExpiryDate)=="" or str(CVVnumber)=="" or str(AmountForPaying)=="" or str(CardHolderName)==""):
            ...
            print('Paying information : ', payingAmount)
        ...
        print('Merchant information : ', merchent)
